...
\pagestyle{empty}
\geometry{letterpaper,tmargin=0.75in,bmargin=0.75in,lmargin=0.75in,rmargin=0.75in,headheight=0in,headsep=0in,footskip=0in}
...
\item Engineer and sysadmin in a ``cloud'' multi-tenant high-performance computing environment.
...
\item Development of infrastructure and automation for building virtual private compute clusters.
\item Performance tuning and debugging of a variety of applications in domains including weather forecasting, 
computational fluid dynamics, finite element analysis,
bioinformatics and actuarial science.
\item Provide support for academic and commercial researchers with a variety of skill levels in HPC.
...
\item Trained and supervised undergraduate researchers and helped maintain group resources. 
...
\begin{itemize}\setlength{\itemsep}{0cm}
  \setlength{\parskip}{0cm}
		...
		\item Extensive experience with configuration and maintenance of HPC clusters for on-demand use.
		\item Proficient with cluster frameworks including Torque, Grid Engine, Hadoop, Perceus, and HPC Pack 2008.
		...
		\item Strong background in scientific research and research computing.
...
\begin{itemize}\setlength{\itemsep}{0cm}
  \setlength{\parskip}{0cm}
\item Academic publications in \textit{Physical Review Letters}, \textit{Soft Matter}, and \textit{Chemistry: A European Journal}.
\item Talks to the Materials Research Society, the University of Illinois and the Society of Actuaries (invited talk).
\item Full list may be found at http://www.ajdecon.org/pubs.
\end{itemize}
...
\begin{itemize}\setlength{\itemsep}{0cm}
  \setlength{\parskip}{0cm}
	\item Strong professional interest in ``big data'' analysis and computational statistics.  Attended the ``Big Data for Science'' workshop at Indiana University 
in July 2010.
	\item Epee fencer for 8 years, currently at The Point Fencing Club in Champaign, IL.
