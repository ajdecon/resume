...
\item Design, deploy, and support private ``cloud'' HPC clusters on R Systems hardware for academic and commercial researchers.
\item Measure and tune behavior of customer applications for best performance and usability.
\item Develop software and pre-built images for automating deployment of custom solutions.
...
\item Active and past projects include:
    \begin{itemize}\setlength{\itemsep}{0cm}
        \setlength{\parskip}{0cm}
        \vspace{-4pt}
        \item Long-term deployment of 600-1000 core RHEL 5.6 cluster for meteorological modeling application.
        \item Long-term deployment of 1000 core Windows 2008 HPC R2 cluster for actuarial application.
        \item Dynamic cluster deployments (Windows and Linux) for high-performance storage vendor benchmarking development hardware.
        \item Over a dozen other cluster deployments for various scientific and engineering applications under short-term contracts 
        (days--months).
    \end{itemize}
\end{itemize}
