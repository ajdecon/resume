...
\pagestyle{empty}
\geometry{letterpaper,tmargin=1in,bmargin=1in,lmargin=0.5in,rmargin=0.5in,headheight=0in,headsep=0in,footskip=0in}
...
\vspace{-1pt} {\small \addr \hfill \phone \hfill \email \hfill \website} % \\ \website \hfill \linkedin}
...
\jobitem{Systems Administrator (Applications)}{R Systems NA, Inc.}{November 2010--present}{Champaign, IL}
...
%\item Project lead on short-term and long-term cluster deployments
%    \begin{itemize}\setlength{\itemsep}{0cm}
%        \setlength{\parskip}{0cm}
%        \vspace{-4pt}
...
%	\begin{itemize}\setlength{\itemsep}{0cm}
%	\setlength{\parskip}{0cm}
%	\item Image processing and mathematical morphology
%	\item Microscopy: optical, fluorescent, SEM, confocal
%	\item Microfabrication with silicon and soft materials
