...
\pagestyle{empty}
\geometry{letterpaper,tmargin=0.5in,bmargin=0.5in,lmargin=0.75in,rmargin=0.75in,headheight=0in,headsep=0in,footskip=0in}
...
\item Engineer in a high-performance computing environment providing on-demand access to private clusters.
\item Provisioning, configuration and maintenance of compute clusters running both Linux and Windows.
...
\item Development of infrastructure and automation for managing virtual private compute clusters.
\item Performance tuning and debugging of applications in domains including weather forecasting, 
...
\begin{itemize}\setlength{\itemsep}{0cm}
  \setlength{\parskip}{0cm}
		...
		\item Extensive experience with provisioning, configuration and maintenance of HPC clusters.
		\item Proficient with HPC frameworks including Perceus, Cobbler, Torque, SGE, Hadoop, and HPC Pack 2008 R2.
        \item Production experience with scientific programming and automation in Python, Perl, Java, and Matlab.
        \item Classroom or personal experience with scientific programming in Fortran, C, and R.
...
%		\item Some experience with Fortran, C, Visual Basic and R.
		\item Strong background in scientific research and scientific computing.
        \item Extensive experience working with scientists and engineers in commercial and academic settings.
...
\item A full list may be found at http://www.ajdecon.org/projects/pubs.
\end{itemize}
...
\begin{itemize}\setlength{\itemsep}{0cm}
  \setlength{\parskip}{0cm}
    ...
    \item Participated in the development of Warwulf, the open-source cluster manager from Berkeley National Lab.
